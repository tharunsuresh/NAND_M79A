...
#define MT29F2G01ABAGD
	...
	Page data only:
		...
		device  => 131072 bytes/block * 2048 blocks  = 268,435,456 bytes (256 MB, 0x10_000_000 addresses)

	With spares:
		1 page  => (2048 data + 128 bytes spare)     =   2176 bytes/page
		1 block => 2176 bytes/page * 64 pages/block  = 139264 bytes/block = 136 KB/block
		device  => 139264 bytes/block * 2048 blocks  = 285,212,672 bytes (2176 Mb, 272 MB, 0x11_000_000 addresses)
	*/
	...
	/* Register Addresses (see Datasheet page 37) */
	typedef enum {
